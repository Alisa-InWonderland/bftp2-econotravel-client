    ...
    return (
        <div className="about-container">
            <div className="about-card">
                ...
                <h2 className="title-mission">Misión</h2>
                <p className="mission-text">Nuestra empresa se fundó a raíz de un viaje que nuestra fundadora, Marina
                    Herrán, realizó en bicicleta por Cataluña en el verano de 2001. Durante ese periodo, descubrió que
                    las opciones turísticas que ofrecían ciudades como Barcelona, Girona y Reus dependían de transportes
                ...
                <br/>
                <p className="mission-text" id="paragr-2">Preocupada por la falta de alternativas eco-friendly, Marina se propuso
